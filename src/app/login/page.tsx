      ...
      <div className=" flex justify-center items-center h-screen">
        <div className="w-full max-w-md p-8 space-y-3 rounded-xl border bg-white   font-sans mx-auto">
          <div className=" text-black">
            <Link className="text-[19px] font-normal" href={"/"}>
              Back
            </Link>
          </div>
          ...
          <form onSubmit={handleLogin} action="" className="space-y-6">
            <div className="space-y-2 text-sm">
              ...
              <input
                ...
                className="w-full px-4 py-3 text-black rounded-md border border-indigo-300 focus:outline-none focus:ring  "
              />
            </div>
            <div className="space-y-2 text-sm">
