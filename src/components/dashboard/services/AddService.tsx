...
const AddService = ({ mutate }: any) => {
  ...
  const addServiceHandler = (data: any) => {
  ...
  return (
    <>
      ...
      >
        ...
        <span className=" text-[17px]"> Add new Service</span>
      </button>
      <CommonModal active={active} setActive={setActive}>
        <h1 className="text-[18px] font-medium flex pb-2 text-white">
          Service
        </h1>
        <form onSubmit={handleSubmit(addServiceHandler)} action="" className="">
