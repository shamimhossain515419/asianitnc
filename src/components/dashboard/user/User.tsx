...
const User = () => {
  const {
    ...
    isLoading,
    mutate,
  } = useSWR(`${process.env.BASE_URL}/api/user/all`, fetcher);

  // user Delete Handler

  const [deleteModal, setDeleteOpenModal] = useState<userInterface>();
  const [updateModal, setUpdateModal] = useState<userInterface>();
  ...
  return (
    <>
      ...
      {updateModal && (
        <UpdateUser updateModal={updateModal} setUpdateModal={setUpdateModal} />
      )}
                      ...
                      >
                        ...
                        >
                          <div className=" space-y-2">
                            <div
                              onClick={() => setDeleteOpenModal(user)}
