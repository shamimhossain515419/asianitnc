...
import { SliderInterface } from "@/utility/Interface";
...
const SliderTable = () => {
    ...
    //  delete action  state
    const [deleteModal, setDeleteOpenModal] = useState<SliderInterface>();
    ...
    return (
        <>
            ...
            <DeleteSlider
                ...
                mutate={mutate}
            />
            <div className=" pt-2  w-full pb-10 flex justify-between items-center gap-5">
                <div>
                    {/* total user  */}
                    <h1 className=" text-[20px] font-bold">
                        Total Slider: {SliderData?.body?.length}
                    </h1>
                </div>
                {/* add Slider button  */}
                <AddSlider mutate={mutate} />
            </div>
