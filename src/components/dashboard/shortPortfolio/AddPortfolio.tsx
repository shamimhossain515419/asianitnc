    ...
    return (
        <>
            ...
            >
                ...
                <span className=" text-[17px]"> add new short portfolio</span>
            </button>

            <CommonModal active={active} setActive={setActive}>
                <h1 className="text-[19px] font-medium flex pb-2 text-white">Add new short portfolio</h1>
