...
const AddTeam = ({ mutate }: any) => {
    ...
    const addTeamHandler = async (data: any) => {
        ...
        <>
            ...
            <CommonModal active={active} setActive={setActive}>
                ...
                >
                    ...
                    <div className="relative  rounded-lg mt-4 ">
                        <textarea className="peer w-full rounded-lg border border-[#1B8EF8] px-4 py-2 text-white focus:outline-none bg-transparent"
